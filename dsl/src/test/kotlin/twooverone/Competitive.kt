...
- 非正常無將(2NT/4NT/5NT)：兩個最低級未叫花色牌組，5-5以上
- 技術性賭倍：對未叫花色有支持或16+點
- 米切爾扣叫：扣叫低花=雙高花5-4以上
...
fun BiddingTree.defenseToOneMajor() {
    ...
    // 簡單蓋叫
    remark(W, "簡單蓋叫：7-15點，5+張牌組")

    // 跳蓋叫
    remark(W, "跳蓋叫：阻擊性，6-7張牌組")

    // 2NT非正常無將
    "2N" - "非正常無將：兩最低級未叫牌組，5-5以上" {
        "3C" - "選擇C"
        "3D" - "選擇D"
    }
