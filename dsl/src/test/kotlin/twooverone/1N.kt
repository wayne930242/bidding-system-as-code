...
fun BiddingTree.oneNoTrump() {
    ...
    // Minor Suit Stayman
    "2S" - "低花司臺曼：問4張低花，或D長排組弱牌，或5-4+雙低花滿貫意圖" {
        minorSuitStayman()
    }

    // 2NT Transfer to 3C
    "2N" - "轉移叫：C長排組弱牌，或三花色排組好牌(4-4-4-1/5-4-4-0)滿貫意圖" {
        "3C" - "接受轉移" {
            "Pass" - "C長排組弱牌示弱"
            "3D" - "短排組D，4-4-4-1或5-4-4-0滿貫試探"
            "3H" - "短排組H，4-4-4-1或5-4-4-0滿貫試探"
            "3S" - "短排組S，4-4-4-1或5-4-4-0滿貫試探"
        }
    }
...
/**
 * 傑考培轉移叫到H
 * 可能是5+H，或單排組滿貫試探(瓦魯許接力叫)
 */
private fun BiddingTree.jacobyToHearts() {
    "2H" - "接受轉移" {
        "Pass" - "弱牌，由開叫者打"
        "2S" - "單排組滿貫試探，要求開叫者接力叫2NT" {
            "2N" - "接力" {
                warushiRelay()
            }
        }
    ...
    "3C" - "3張H支持，C排組實力集中，邀叫進局"
    "3D" - "3張H支持，D排組實力集中，邀叫進局"
}
...
private fun BiddingTree.jacobyToSpades() {
    ...
    "3C" - "3張S支持，C排組實力集中，邀叫進局"
    "3D" - "3張S支持，D排組實力集中，邀叫進局"
}
